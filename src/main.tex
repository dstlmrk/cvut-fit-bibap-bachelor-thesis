...
\abstractEN{This bachelor's thesis deals with backend design and realization of~the~web application.
...
Functional web app together with its backend, which is independent of frontend, are the main goals of the project.
}
\placeForDeclarationOfAuthenticity{V~Praze}
\declarationOfAuthenticityOption{4} %volba Prohlášení (číslo 1-6)
\keywordsCS{webová služba, REST API, Python, framework Falcon, Ultimate Frisbee}
\keywordsEN{web service, REST API, Python, framework Falcon, Ultimate Frisbee}
